let stringArray = ["Add more contrast", "Remove additional contrast", "Light mode", "Dark mode"];
...
function addContrastControl() {
    addEvent("contrast", [stringArray[0], stringArray[1]], "contrast");
}
